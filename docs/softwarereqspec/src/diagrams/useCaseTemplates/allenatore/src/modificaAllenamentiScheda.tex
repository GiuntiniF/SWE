...
\begin{tabularx}{\textwidth}{|l|X|}
  \hline
  \ucid{PT-04} \\ \hline
  \ucname{Configurazione Sessioni di Allenamento in Template
    di Scheda} \\ \hline
  \ucactor{PT} \\ \hline
  ...
  \ucprecond{Il PT deve essere loggato e deve
    essere presente almeno un template di scheda da modificare.} \\ \hline
  \ucpostcond{Vengono configurati gli allenamenti in
    un template di una scheda.} \\ \hline
  \ucmainflow{
  ...
  \ucvariations{
    ...
    - Se viene selezionata una variante potrebbero essere richiesti
    ...
    del tempo di esecuzione in quella di densità.)
  } \\ \hline
\end{tabularx}
\end{document}
