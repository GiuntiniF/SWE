...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \ucmainflow{
    ...
    \item Il sistema mostra la pagina di dettaglio dell'atleta, che
      ...
      \begin{itemize}
        ...
        \item l'elenco degli allenamenti che l'atleta ha registrato
          come svolti, dal più recente, con la data, la scheda, la
          settimana e la sessione cui si riferiscono e il numero di
          esercizi risultati saltati (vedi Note 5 e 6).
      \end{itemize}
  ...
  \ucaltflow{
    ...
    dell'elenco delle schede assegnate, per modificarne gli
    allenamenti limitatamente a quell'atleta. \newline
    - Il flusso continua dal passo 3 del caso d'uso PT-09. \newline
    \textbf{5b. Consultazione di un allenamento registrato} \newline
    - Il PT preme su un allenamento dell'elenco degli allenamenti
    registrati. \newline
    - Il sistema mostra, per ciascun esercizio di quella sessione, i
    valori prescritti all'atleta e quelli che l'atleta ha registrato
    di avere svolto, segnalando gli esercizi marcati come
    saltati. \newline
    - Il flusso termina.
  } \\ \hline
  \ucnote{
    ...
    \textbf{Nota 2:} gli elenchi di schede, sessioni, richieste e
    allenamenti registrati possono essere vuoti; in tal caso il
    sistema mostra la corrispondente sezione vuota, senza che il
    flusso cambi.\newline
    ...
    \textbf{Nota 5:} gli allenamenti registrati sono scritti
    esclusivamente dall'Atleta (caso d'uso A-02). Il PT non può
    crearli, modificarli né cancellarli, coerentemente con la Nota 1;
    il sistema non lo avvisa quando un atleta ne registra uno, ed è
    il PT a consultarli quando lo ritiene opportuno.\newline
    \textbf{Nota 6:} l'assenza di un allenamento registrato significa
