...
\subsubsection{PT-01: Login PT}
\subfile{../diagrams/useCaseTemplates/allenatore/src/loginAllenatore}

\subsubsection{PT-02: Registrazione nuovo Atleta}
\subfile{../diagrams/useCaseTemplates/allenatore/src/creazioneCliente}

\subsubsection{PT-03: Creazione nuovo Template Scheda}
\subfile{../diagrams/useCaseTemplates/allenatore/src/creazioneTemplateScheda}

\subsubsection{PT-04: Configurazione Sessioni di Allenamento in Template}
...
\subsubsection{A-01: Registrazione Atleta}
\subfile{../diagrams/useCaseTemplates/cliente/src/registrazioneCliente}

\subsubsection{A-02: Login Atleta}
\subfile{../diagrams/useCaseTemplates/cliente/src/loginCliente}
