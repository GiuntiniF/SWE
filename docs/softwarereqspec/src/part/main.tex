...
\subfile{../diagrams/useCaseTemplates/allenatore/src/personalizzazioneScheda}
...
\subsubsection{A-02: Registrazione Allenamento Svolto}
\subfile{../diagrams/useCaseTemplates/cliente/src/registrazioneAllenamento}
